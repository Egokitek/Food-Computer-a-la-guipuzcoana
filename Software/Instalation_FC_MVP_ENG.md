# Instalation of Software: MVP III

#### English versión developed by Howard Webb

# MVP III

## Latest Release: 3.1.8

### Change Log: 2018/11/24
...
Code and instructions for building the 'brain' of the controled environment hydroponics unit. It is mostly a collection of python code that runs on a Raspberry Pi (or similar device).  See the OpenAg [forums](http://forum.openag.media.mit.edu/) for discussion and issues:
